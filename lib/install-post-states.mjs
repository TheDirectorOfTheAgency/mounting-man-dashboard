...
export const INSTALL_POST_STATES = Object.freeze({
  ...
  READY: 'READY',
  // Approved and gate-passed, waiting for the M1 publisher. No cloud dispatch
  // exists, so nothing here is in flight and nothing will time out.
  READY_FOR_M1: 'READY_FOR_M1',
