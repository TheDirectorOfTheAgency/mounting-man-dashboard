...
// Woodward — this is a dedicated operator webhook with the same header shape
// as the Woodward desk wake.
...
/** Same Bearer + x-webhook-secret shape as the Woodward wake. */
