...
// Kronkite (Grok Bot routine) sender-key header. This repo has no Kronkite
// inbound example; dashboard webhooks already use x-webhook-secret (see
// zenbooker.js). Documented so Mr. Wayne can paste the routine-panel key.
