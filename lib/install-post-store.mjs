...
//
// The mobile surface (publicJobView / safeSeed) never includes a customer
// name, full address, or Square identifier. Server job records stamp
// top-level orderId / paymentId / invoiceId for bind and audit.
...
/** One normalized, unapproved record per seed. New Square visits emit one seed. Pure. */
...
export function createInstallPostStore(kv, {
   ...
   * publicJobView / safeSeed still omit these identifiers.
   */
...
/**
 * Stage one cloud job per seed and return its operator link.
 *
